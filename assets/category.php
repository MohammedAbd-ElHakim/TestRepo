...
<head>
    ...
    <title><?php echo $row17['web_name'];?>  | <?php echo $_GET['cat_name']?></title>
</head>
<body>
    ...
    <div class="title2_content"><?php echo $_GET['cat_name']?></div>
  ...
  <div class="product-container">
    ...
    <?php
     if(isset($_GET['cat_name'])){
      ...
      $sql11="SELECT * FROM products WHERE category='$cat_name'";
...
<!-- close content -->
    ...
    <!-- footer -->
<footer class="title-footer" style="position: absolute; bottom:0px;"> جميع الحقوق محفوظه &copy; <?php echo date('Y');  echo " " . $row17['web_name'];?> smsm@me.com </footer>
    <!--  -->
    <style>
      .dep:hover{
        color:#0088ff;
