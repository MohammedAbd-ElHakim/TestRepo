    ...
    <div class="content">
        ...
        <div class="content-bar">
          ...
          <div class="path-bar">
                ...
                <button onclick="window.open('add_admin','_self');">اضف مدير جديد</button>
            </div>
            ...
            <table class="table table-bordered" role="table">
                <thead>
                    <tr>
                        <th width="2%">#</th>
                        <th class="text-right" width="20%"> اسم المدير</th>
                        <th class="text-right" width="30%">كلمه السر</th>
                ...
                <tbody>
                   ...
                   while($row=$result->fetch_assoc()){
                    echo "<tr> 
                    <td><span class='badge'>".$row['admin_id']."</span></td>
                    <td><span class='badge'>".$row['admin_user']."</span></td>
                    ...
                    <a style='text-decoration: none; color:black; background-color:#95A5A6; padding:3px 10px; border-radius:3px; font-weight:500px; ' href='edit_director?admin_id=".$row['admin_id']."' class='btn btn-default btn-xs' target='_blank'>تعديل</a>                         
                    <a href='del_director?admin_id=".$row['admin_id']."' style='text-decoration: none; color:black; background-color:#E74C3C; padding:3px 10px; border-radius:3px; font-weight:500px; ' target='_self'>حذف</a>                        </td>
                    </td>
                  </tr>";
                   }
                   ?>
