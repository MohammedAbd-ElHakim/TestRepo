                ...
                <tbody style="background-color:#ECF0F1; text-align:center;">
                  ...
                  mysqli_close($conn);
                    ...
                    while($row=$result->fetch_assoc()){
                        ...
                        <a style='text-decoration: none; color:black; background-color:#95A5A6; padding:3px 10px; margin-bottom:3px; border-radius:3px; font-weight:500px; ' href='http://localhost/ecomweb/send_to_delivered?prd_id=$product_id&&prd_name=$products_name&&prd_quantity=$quan ' class='btn btn-default btn-xs' target='_blank'>التفاصيل</a>                         
