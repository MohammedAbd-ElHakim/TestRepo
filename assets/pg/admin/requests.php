    ...
    <div class="content">
        ...
        <div class="content-bar">
          ...
          <div class="path-bar">
                ...
                <div class="url-path">الطلبات</div>
            </div>
              ...
              <thead>
                ...
                <tbody style="background-color:#ECF0F1; text-align:center;">
                    ...
                    if (isset($_GET['delete_id'])) {
                      ...
                      $sql7 = "UPDATE orders SET status = 0 WHERE id = '$order_id'";
                      if (mysqli_query($conn, $sql7)) {

                      } else {
                        echo "خطأ في الغاء الطلب: " . mysqli_error($conn);
                      }
                    ...
                    while($row=$result->fetch_assoc()){
                        ...
                        <a style='text-decoration: none; color:black; background-color:#95A5A6; padding:3px 10px; margin-bottom:3px; border-radius:3px; font-weight:500px; ' href='http://localhost/ecomweb/detail_order?prd_id=$product_id&&prd_name=$products_name&&prd_quantity=$quan ' class='btn btn-default btn-xs' target='_blank'>التفاصيل</a>                         
                        <a href='?delete_id=" . $row["id"] . "' onclick='return confirm(\"هل أنت متأكد من الغاء الطلب؟\")' style='text-decoration: none; color:black; background-color:#E74C3C; padding:3px 10px; border-radius:3px; font-weight:500px; '>الغاء الطلب</a>
                    </td>
                </tr>";
                    }
                    ?>
            ...
            <form action="http://localhost/ecomweb/detail_order" method="POST">
              <input type="hidden" name="prduct_name" value="<?php
                 echo $product_name; ?>">
              <button type="submit" style="margin:20px;" class="btn-style">تحميل الكل</button>
           </form>
            <script>
