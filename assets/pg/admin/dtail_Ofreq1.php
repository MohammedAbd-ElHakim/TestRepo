        ...
        <div class="content-bar">
          <div class="path-bar">
            ...
            <div class="detail_countainer">
             ...
             <form action="http://localhost/ecomweb/confirm_to_ship.php?prd_id=<?php echo urlencode($prd_id); ?>&prd_name=<?php echo urlencode($product_name); ?>" method="POST">
                <button class="mbtn" type="submit" name="submit">تأكيد الطلب</button>       
             </form>
             </div>   
               </div>
               <!-- second box -->
               ...
               <div class="box_price  box">
                 ...
                 <div class="price det ">
                    <?php
                    if($row['shipping'] == "مجاني" || $row['shipping'] == 0 || $row['shipping'] == "0"){
                      $shippng=1;
                    }
                    echo  $row['shipping'];
                    ?>
                ...
                <div class="box_price  box">
                 ...
                 <div class="price det ">
                    <?php
                    echo( $row['price'] + $shippng) * $prd_quan;
                    ?>
                </div>
               </div>
                         <!--  حاله الطلب  -->
