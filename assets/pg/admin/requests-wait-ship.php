    ...
    <div class="content">
        ...
        <div class="content-bar">
          ...
          <div class="path-bar">
                ...
                <div class="url-path">الطلبات بانتظار الشحن</div>
            </div>
              ...
              <thead>
                ...
                <tbody style="background-color:#ECF0F1; text-align:center;">
                    ...
                    while($row=$result->fetch_assoc()){
                        ...
                        <a href='?delete_id=" . $row["id"] . "' onclick='return confirm(\"هل أنت متأكد من حذف الطلب؟\")' style='text-decoration: none; color:black; background-color:#E74C3C; padding:3px 10px; border-radius:3px; font-weight:500px; '>حذف</a>
                    </td>
                </tr>";
                    }
                    ?>
